...
{
    //TCP connection needs a way to detect other peers.
    //use USP broadcasting feature from PeerConnectionUDP to achieve this
    class PeerConnectionTCP
    {

        //Constructor - found a 
        public PeerConnectionTCP(string ipAddress) : base(ipAddress)
        {
